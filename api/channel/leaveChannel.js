...
module.exports = async function(req, res) {
    ...
    .catch((err) => {
        console.log("채널 가입 확인중 오류가 발생하였습니다\n" + err);
        return res.status(500).json({ status : 500, message : "채널 가입 확인중 오류가 발생하였습니다" });
    })
}